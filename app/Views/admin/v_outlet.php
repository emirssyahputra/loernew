              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a class="btn btn-info btn-rounded btn-fw float-left"
                    href="<?php echo site_url('TambahOutlet'); ?>"><i class="fa fa-plus btn-icon-prepend">
                    </i> Tambah </a>
                      ...
                      <tbody>
                        <?php foreach ($outlet as $index => $cabang):
                          ...
                          <tr>
                            ...
                            <td align="left">
                              <a href="<?php echo site_url('UbahOutlet/' . $id); ?>" type="button" title="Ubah Data"
                                class="btn btn-warning btn-icon-text">
                                <i class="fa fa-pencil btn-icon-append"></i> Ubah
                              </a>
                              &nbsp;&nbsp;&nbsp;
                              <!-- Button untuk membuka pop-up -->
                              <a href="<?php echo site_url('Outlet/hapus/' . $id); ?>" type="button" data-id="<?= $id ?>"
                                title="Hapus Data" class="btn btn-danger btn-icon-text" id="openDeletePopup1">
