        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ubah Data FAQ</h4>
                  <form class="forms-sample" method="POST" action="<?= site_url('UbahFAQ/update'); ?>">
                    <input type="hidden" name="id_faq" value="<?= $faq['id_faq'] ?>"> <!-- Add this line -->

                    <div class="form-group">
                      <label>Pertanyaan</label>
                      <textarea name="ask" rows="7" class="form-control"
                        placeholder="Pertanyaan"><?= esc($faq['ask']) ?></textarea>
                    </div>

                    <div class="form-group">
                      <label>Jawaban</label>
                      <textarea name="question" rows="7" class="form-control"
                        placeholder="Jawaban"><?= esc($faq['question']) ?></textarea>
                    </div>

                    <button type="submit" class="btn btn-warning btn-icon-text">Simpan</button>
                    <a class="btn btn-danger btn-icon-text" href="<?= site_url('FAQ'); ?>">Batal</a>
                  </form>
