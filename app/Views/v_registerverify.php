    ...
    <div class='login-outer-container'>
        <div class='login-container'>
            <div class='login-area'>
                ...
                <p>Silakan cek email Anda, kami telah mengirimkan kode OTP untuk mendaftar akun anda.</p>
                ...
                <!-- Tampilkan Pesan Kesalahan OTP Tidak Valid -->
                <?php if (session()->getFlashdata('error')): ?>
                    <div class="alert alert-danger">
                        <?php echo session()->getFlashdata('error'); ?>
                    </div>
                <?php endif ?>
                <form class='login-items' action="<?= site_url('register/verifyProcess') ?>" method="post">
                ...
                <p class='p'><a class='a' href="<?php echo site_url('register'); ?>">Kembali ke Register</a></p>
            </div>
        </div>
    </div>
</body>
